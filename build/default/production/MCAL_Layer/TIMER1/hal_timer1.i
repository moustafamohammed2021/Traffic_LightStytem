...
# 11 "MCAL_Layer/TIMER1/../GPIO/../mcal_std_types.h"
...
# 11 "MCAL_Layer/TIMER1/../GPIO/../mcal_std_types.h" 2
...
# 1 "MCAL_Layer/TIMER1/../GPIO/hal_gpio_config.h" 1
# 14 "MCAL_Layer/TIMER1/../GPIO/hal_gpio.h" 2
# 32 "MCAL_Layer/TIMER1/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
static __attribute__((inline)) void timer1_select_mode_timer_or_counter(const timer1_config_t *_timer);
static __attribute__((inline)) void timer1_oscillator_enable(const timer1_config_t *_timer);
static __attribute__((inline)) void timer1_select_reg_mode(const timer1_config_t *_timer);

static uint16 preload_timer1=0;
...
Std_ReturnType Timer1_Init(const timer1_config_t *_timer){
    Std_ReturnType ret=(Std_ReturnType)0x01;
        if (((void*)0)==_timer){
            ...
            (T1CONbits.T1CKPS=_timer->timer1_pre_scaler_val);
       ...
       (PIE1bits.TMR1IE=1);
       (PIR1bits.TMR1IF=0);
# 59 "MCAL_Layer/TIMER1/hal_timer1.c"
            (INTCONbits.GIE=1);
            (INTCONbits.PEIE=1);
...
static __attribute__((inline)) void timer1_select_mode_timer_or_counter(const timer1_config_t *_timer){
    if (0==_timer->timer1_mode_timer_or_counter){
        (T1CONbits.TMR1CS=0);
    }
    else if (1==_timer->timer1_mode_timer_or_counter){
        (T1CONbits.TMR1CS=1);
        if (0 ==_timer->timer1_counter_mode_sync){
            (T1CONbits.T1SYNC=0);
        }
        else if (1==_timer->timer1_counter_mode_sync){
            (T1CONbits.T1SYNC=1);
        }
        else { }
    }
...
static __attribute__((inline)) void timer1_oscillator_enable(const timer1_config_t *_timer){
    if (1==_timer->timer1_oscillator_enable){
        (T1CONbits.T1OSCEN=1);
    }
    else if(0==_timer->timer1_oscillator_enable) {
        (T1CONbits.T1OSCEN=0);
    }
    else { }
...
static __attribute__((inline)) void timer1_select_reg_mode(const timer1_config_t *_timer){
    if (0==_timer->timer1_mode_wr_reg){
        (T1CONbits.RD16=0);
    }
    else if (1==_timer->timer1_mode_wr_reg){
        (T1CONbits.RD16=1);
    }
     else { }
}
