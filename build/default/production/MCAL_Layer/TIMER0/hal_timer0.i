...
# 11 "MCAL_Layer/TIMER0/../GPIO/../mcal_std_types.h"
...
# 11 "MCAL_Layer/TIMER0/../GPIO/../mcal_std_types.h" 2
...
# 1 "MCAL_Layer/TIMER0/../GPIO/hal_gpio_config.h" 1
# 14 "MCAL_Layer/TIMER0/../GPIO/hal_gpio.h" 2
# 32 "MCAL_Layer/TIMER0/../GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW=0,
    GPIO_HIGH
}logic_t;
...
# 11 "MCAL_Layer/TIMER0/../interrupt/mcal_internal_interrupt.h"
# 1 "MCAL_Layer/TIMER0/../interrupt/mcal_interrupt_config.h" 1
# 13 "MCAL_Layer/TIMER0/../interrupt/mcal_interrupt_config.h"
# 1 "MCAL_Layer/TIMER0/../interrupt/mcal_interrupt_gen_config.h" 1
...
# 11 "MCAL_Layer/TIMER0/../interrupt/mcal_internal_interrupt.h" 2
...
# 84 "MCAL_Layer/TIMER0/hal_timer0.h"
...
static uint16 preload_timer=0;
static __attribute__((inline)) void Timer0_prescaler_selcet(const timer0_config_t *_timer);
static __attribute__((inline)) void Timer0_mode_of_register_size_selcet(const timer0_config_t *_timer);
static __attribute__((inline)) void Timer0_mode_timer_or_counter_selcet(const timer0_config_t *_timer);
...
Std_ReturnType Timer0_Init(const timer0_config_t *_timer){
    Std_ReturnType ret=(Std_ReturnType)0x01;
      ...
      preload_timer=_timer->timer0_preloaded_value;
       (INTCONbits.TMR0IE=1);
       (INTCONbits.TMR0IF=0);
# 61 "MCAL_Layer/TIMER0/hal_timer0.c"
            (INTCONbits.GIE=1);
            (INTCONbits.PEIE=1);
...
Std_ReturnType Timer0_read_value(const timer0_config_t *_timer,uint16 *_value){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    uint8 L_Read_low=0,L_Read_high=0;
...
static __attribute__((inline)) void Timer0_prescaler_selcet(const timer0_config_t *_timer){
    if (1==_timer->timer0_prescaler_enable){
        (T0CONbits.PSA=0);
        T0CONbits.T0PS=_timer->_prescaler_value;
    }
    else if (0==_timer->timer0_prescaler_enable){
        (T0CONbits.PSA=1);
    }
    else {}
}
...
static __attribute__((inline)) void Timer0_mode_of_register_size_selcet(const timer0_config_t *_timer){
    if (1==_timer->timer0_mode_register_size){
        (T0CONbits.T08BIT=1);
    }
    else if (0==_timer->timer0_mode_register_size){
      (T0CONbits.T08BIT=0);
    }
     else {}
}
...
static __attribute__((inline)) void Timer0_mode_timer_or_counter_selcet(const timer0_config_t *_timer){
    if (1==_timer->timer0_mode_timer_or_counter){
        (T0CONbits.T0CS=0);
    }
    else if (0==_timer->timer0_mode_timer_or_counter){
      (T0CONbits.T0CS=1);
