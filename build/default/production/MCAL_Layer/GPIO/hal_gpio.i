...
# 101 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_Pin_Read_Logic (const pin_config_t *pin_config,logic_t *logic){
    Std_ReturnType ret=(Std_ReturnType)0x01;
...
# 121 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_Pin_Toggle_Logic (const pin_config_t *pin_config){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if (((void*)0)==pin_config || pin_config->pin > 8 -1){
        ret=(Std_ReturnType)0x00;
...
# 163 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_Port_Derction_Intialize(port_index_t port ,uint8 direction){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if (port > 5){
        ret=(Std_ReturnType)0x00;
...
# 185 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_Port_Get_Derction_Status(port_index_t port,uint8 *direction_status){
    Std_ReturnType ret=(Std_ReturnType)0x01;
...
# 206 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_Port_Write_Logic(port_index_t port,uint8 logic ){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if (port > 5){
        ret=(Std_ReturnType)0x00;
...
# 247 "MCAL_Layer/GPIO/hal_gpio.c"
Std_ReturnType gpio_Port_Toggle_Logic (port_index_t port){
    Std_ReturnType ret=(Std_ReturnType)0x01;
    if (port > 5){
        ret=(Std_ReturnType)0x00;
